...
describe("Mercader", () => {
  ...
  test('debería permitir modificar el nombre del mercader', () => {
    const mercader = new Mercader(2, 'Fergus Graem', 'Mercader General', 'Velen');
  ...
  test('debería permitir modificar la ubicación del mercader', () => {
    const mercader = new Mercader(4, 'Mercader X', 'Mercader General', 'Kaer Trolde');
  ...
  test('debería permitir modificar secuencialmente nombre, tipo y ubicación', () => {
    const mercader = new Mercader(8, 'Original', 'Mercader General', 'Novigrado');
